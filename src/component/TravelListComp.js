...
// {/*                <p className="text-gray-700 text-base">Our wheat flour grinding service provides fresh,*/}
// {/*                    high-quality*/}
// {/*                    flour to businesses and individuals in the area. We use state-of-the-art equipment*/}
// {/*                    to grind*/}
// {/*                    wheat into flour, and we offer a variety of flours to meet the needs of our*/}
// {/*                    customers.</p>*/}
// {/*            </div>*/}
// {/*        </div>*/}
// {/*        <div className="bg-white rounded-lg shadow-md overflow-hidden">*/}
...
// {/*                <p className="text-gray-700 text-base">Our gram flour is perfect for a variety of uses,*/}
// {/*                    including*/}
// {/*                    baking, cooking, and making snacks. It is also a good source of protein and*/}
// {/*                    fiber.Our gram flour*/}
// {/*                    grinding service is a convenient and affordable way to get the freshest gram flour*/}
// {/*                    possible.</p>*/}
// {/*            </div>*/}
// {/*        </div>*/}
// {/*        <div className="bg-white rounded-lg shadow-md overflow-hidden">*/}
...
// {/*                <p className="text-gray-700 text-base">Our jowar grinding service is a convenient and*/}
// {/*                    affordable way to*/}
// {/*                    get fresh, high-quality jowar flour. We use state-of-the-art equipment to grind*/}
// {/*                    jowar into a*/}
// {/*                    fine powder, which is perfect for making roti, bread, and other dishes.*/}
// {/*                    <details>*/}
// {/*                        <summary>Read More</summary>*/}
// {/*                        <p>Our jowar flour is also*/}
// {/*                            a good source of protein and fiber, making it a healthy choice for your*/}
// {/*                            family.</p>*/}
// {/*                    </details>*/}
// {/*                </p>*/}
//
...
// {/*                <p className="text-gray-700 text-base">We specializes in the production of high-quality*/}
// {/*                    chili powder.*/}
// {/*                    Our chili powder is made from the finest, freshest chilies, and we use traditional*/}
// {/*                    pounding*/}
// {/*                    methods to ensure that our chili powder retains its full flavor and aroma.*/}
// {/*                    <details>*/}
// {/*                        <summary>Read More</summary>*/}
// {/*                        <p> We offer a variety of chili powder products, including mild, medium, and*/}
// {/*                            hot. We also offer*/}
...
// {/*                <p className="text-gray-700 text-base">Our company produces high-quality rice papad that*/}
// {/*                    is made with*/}
// {/*                    the finest ingredients. We use traditional methods to make our papad, which gives it*/}
// {/*                    a unique*/}
// {/*                    flavor and texture. Our papad is also gluten-free and vegan.*/}
// {/*                    <details>*/}
// {/*                        <summary>Read More</summary>*/}
// {/*                        <p> We offer a variety of rice papad flavors, including plain, salted, spicy,*/}
// {/*                            and flavored. We*/}
// {/*                            also*/}
// {/*                            offer a variety of sizes and shapes to choose from. Our papad is available*/}
// {/*                            in bulk or in*/}
